...
## Acceptance of Terms
By downloading, installing, or using Neurise, you agree to these Terms of Service.

## Eligibility
The service is intended for users aged 16 and over. If your local law requires a higher age to consent to data processing, you may use Neurise only with the consent of a parent or legal guardian.

## Description of Service
Neurise is a mobile application designed to support happiness and wellness using evidence-based approaches from cognitive and behavioral science.

## Privacy
Your use of the service is also governed by our Privacy Policy. That policy explains what data we collect, how we use it, and your rights. You must review and accept it to use the service.
...
- Access or scrape the service using automated tools
- Use the service to harass or harm others
- Share your account credentials with others

## Intellectual Property
All content, features, and functionality of Neurise are owned by Neurise and protected by intellectual property laws.

## Third-Party App Stores
If you downloaded the app from the Apple App Store or Google Play Store, their terms also apply to your use of the service. Apple and Google are not responsible for providing support or maintenance for the service. You agree that they have no liability related to your use of Neurise.

## Feedback
If you provide feedback, ideas, or suggestions, you grant Neurise a licence to use them for any purpose without obligation or compensation. You agree that we are not required to act on any feedback.
...
## Service Changes
We may modify, suspend, or discontinue any part of the service at any time. We are not liable for any such changes.

## Indemnification
You agree to indemnify and hold Neurise harmless from any claims, damages, or losses arising from your misuse of the service or your violation of these terms.

## Termination
We may suspend or terminate your access to the service at our sole discretion if we believe you have violated these terms.

## Changes to Terms
We may update these Terms of Service from time to time. Continued use of Neurise after any update constitutes acceptance of the revised terms.

## Governing Law
These Terms of Service are governed by the laws of England and Wales. Any disputes will be handled exclusively in the courts of that jurisdiction.

## Contact Information
If you have questions about these Terms of Service, contact us at [hello@neurise.app](mailto:hello@neurise.app).
